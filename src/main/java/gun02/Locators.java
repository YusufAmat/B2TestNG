...
public class Locators {
    ...
    public static final By lSidePanemAdmin = By.xpath(".//aside//a[.='Admin']");
    public static final By lDropdownRole = By.xpath(".//label[.='User Role']/ancestor::div[contains(@class,'oxd-grid-item')]");
    //public static final By lDropdownRole = By.xpath(".(//div[@class='oxd-select-wrapper'])[1]");
    public static final By lOptionAdmin = By.xpath(".//div[@role='option' and .='Admin']");
    public static final By lSearchButton = By.xpath("//button[@type='submit' and contains(., 'Search')]");
    public static final By lTableCell3 = By.xpath("//div[@role='table']//div[contains(@class,'oxd-table-cell')][3]");
    //public static final By lTableCell3 = By.xpath("//div[@class='oxd-table-body']/div/div/div[3]");
